"""PC_base_v4: Integrate best_item into the program. This takes the list of
items generated by the user, sorts by unit price and finds the cheapest item,
providing that it fits in the budget. If no items fit in the budget, it just
takes the cheapest item. All necessary components have been integrated into
the program.
Jack Andrews
30/5/22
"""
...
def main(stdscr: curses.window):
    ...
    product_list = product_loop(stdscr, base_unit, budget)
